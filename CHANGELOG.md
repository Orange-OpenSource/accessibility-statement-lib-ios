...
## [1.4.3](https://github.com/Orange-OpenSource/accessibility-statement-lib-ios/compare/1.4.2...1.4.3) - 2026-01-26

### Fixed

- The "more details" component should be a link instead of a button (Orange-OpenSource/accessibility-statement-lib-ios#65)

## [1.4.2](https://github.com/Orange-OpenSource/accessibility-statement-lib-ios/compare/1.4.1...1.4.2) - 2026-01-26

### Fixed

- Remove dead code deleated to OUDS breaking compilations

## [1.4.1](https://github.com/Orange-OpenSource/accessibility-statement-lib-ios/compare/1.4.0...1.4.1) - 2026-01-26
