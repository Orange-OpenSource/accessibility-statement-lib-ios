...
DOCUMENTATION_HTML_LOCATION="/tmp/accessibility-statement-lib-ios-$timestamp"

# Relative path for assets on the branch
DOCS_DIRECTORY=".."

# The ZIP containing the generated sources of documentation (for archive).
DOCUMENTATION_ZIP_NAME="accessibility-statement-lib-ios-docs-$timestamp.zip"
...
show_help() {
    echo "This script will generate web files (HTML, CSS, JSON, JavaScript) for online documentation for accessibility-statement-lib-ios Swift Package"
...
swift package \
    ...
    --target DeclarationAccessibility \
...
# Step 3 - Checkout to service pages dedicated branch (if relevant)
# ------------------------------------------------------------------
...
# Step 4 - Compress ZIP (if relevant)
# -----------------------------------
...
# Step 5 - Resume work on Git branch (if relevant)
# -------------------------------------------------
